...
CLOUDINARY_API_SECRET   = [Add from Firebase Console]
MISTRAL_API_KEY         = [Add from Mistral Dashboard]
MISTRAL_BASE_URL        = https://api.mistral.ai/v1
MISTRAL_MODEL           = mistral-medium-latest
NVIDIA_GEMMA_API_KEY    = [Add from NVIDIA API Portal]
NVIDIA_BASE_URL         = https://integrate.api.nvidia.com/v1
NVIDIA_GEMMA_MODEL      = google/gemma-3-27b-it
OPENWEATHER_API_KEY     = [Add from OpenWeather]
OPENWEATHER_BASE_URL    = https://api.openweathermap.org/data/2.5
SENTRY_DSN              = [Add from Sentry Dashboard]
